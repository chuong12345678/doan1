...
<a id="smallScreen" data-target="#topMenu" data-toggle="collapse" class="btn btn-navbar">
  ...
  <div class="navbar-inner">
    <a class="brand" href="sp.php"><img src="themes/images/logo.png" alt="Bootsshop"/></a>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="<?php echo $ctsp['image']?>" title="simple robot">
				<img src="<?php echo $ctsp['image']?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			<div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                   <a href="<?php echo $ctsp['image']?>"> <img style="width:29%" src="<?php echo $ctsp['image']?>" alt=""/></a>
			...
			<div class="span6">
				<h3><?php echo $ctsp['ProductName'] ?> </h3>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span><?php echo $ctsp['price']?></span></label>
					<div class="controls">
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2"><?php echo $ctsp['ProductName']?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model:</td><td class="techSpecTD2"><?php echo $ctsp['ProductList']?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Released on:</td><td class="techSpecTD2"><?php echo $ctsp['ProductCode']?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Dimensions:</td><td class="techSpecTD2"><?php echo $ctsp['nhasx']?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2"><?php echo $ctsp['link']?></td></tr>
				</tbody>
				</table>
